...
{
    Task<IEnumerable<TenantListDto>> GetAllAsync(string? status = null, string? search = null, int? buildingId = null, int? ownerUserId = null);
    Task<TenantDetailDto?> GetByIdAsync(int id, int? ownerUserId = null);
